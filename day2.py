...
# age=16
# # 2. name
# name = "Jessica" #string variable
# # 3. song
# song = "Happy Birthday" #sring variable
# # 4. food
...
print(phrase2[0]) #print the first letter
print(phrase2[1])
print(phrase2[5]) #prints out the 6th letter
print(phrase2[13])
#string slicing if i wanted to get the entire word
print(phrase2[13:18])
print(phrase2[19:23])
print(phrase2[0:7])
print(phrase2[-1]) #prints out the last letter
...
print(10/2)
# Modulus
print(10%3) #prints out the remainer of the division
# Exponentiation
print(2**3) #2 to the power of 3
# Floor Division
print(10//3) #10 divided by 3 is 3 with a remainer of 1
