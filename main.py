...
# price = 10 #interger variable
# name = "John" # string variable
# rating = 4.9 #float variable
# is_published = True #booblean variable
...
# # cincatention to join variables in a sentcne using the plus (+) sign
# print (name + " has a rating of "+ str(rating))

# # use the str() function to cvonvert a number to a string
